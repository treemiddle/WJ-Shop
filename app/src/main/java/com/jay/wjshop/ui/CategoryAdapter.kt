...
) : ListAdapter<ShopSales, CategoryAdapter.GoodsItemHolder>(object : DiffUtil.ItemCallback<ShopSales>() {
    ...
    class GoodsItemHolder(
        ...
        companion object Factory {
            fun create(parent: ViewGroup): GoodsItemHolder {
                ...
                val view = ItemGoodsBinding.inflate(layoutInflater, parent, false)
